  ...
  return (
    ...
    <div className="AU_section2_gridContainer">
      <div className="AU_section2_gridContainerDiv">
        ...
        <p className='AU_section2_gridContainerDiv_text_Para'> <span style={{fontWeight:"bold"}}>MediRizz&nbsp;</span> 
        
        Our mission at MediRizz is to provide a supportive and informative platform for individuals seeking mental health healing and self-improvement. We believe that mental health is just as important as physical health and that everyone deserves to live a happy, healthy life.
        <br />
        <br />
